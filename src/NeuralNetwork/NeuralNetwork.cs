...
namespace NeuralNetwork
{
    public class NeuralNetwork
    {
        ...
        private NeuralNetwork(NeuralNetworkDto modelDto)
        {
        ...
        {
            var modelDto = new NeuralNetworkDto()
            {
        ...
        public static NeuralNetwork Load(string path)
        {
            ...
            var modelDto = JsonSerializer.Deserialize<NeuralNetworkDto>(json);
            return new NeuralNetwork(modelDto);
        }

        public void PrintOutput()
        {
            _layers.Last().PrintNeurons();
        }
